...
def main():
    ...
    color_cam.setBoardSocket(dai.CameraBoardSocket.RGB)
    #dai.CameraControl().setAutoFocusMode(dai.CameraControl.AutoFocusMode.OFF)
    #dai.CameraControl().setAntiBandingMode(color_cam, dai.CameraControl.AutoFocusMode.Off)
    color_cam.initialControl.setAutoFocusMode(dai.CameraControl.AutoFocusMode.AUTO)
    #color_cam.initialControl.setManualExposure(33000)
